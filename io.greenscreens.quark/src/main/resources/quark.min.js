...
"undefined"!=typeof module&&(module.exports=Security),Security=(()=>{var n=null,e=null,t=null;const r=new TextEncoder;async function i(n,e,t){let r=window.atob(n),i=str2ab(r);return window.crypto.subtle.importKey("spki",i,e,!0,[t])}const a={isActive:function(){return null!==n&&null!==e},init:function(a){return async function(a){console.log("Security Initializing..."),n=await i(a.keyEnc,{name:"RSA-OAEP",hash:"SHA-256"},"encrypt"),e=await async function(){return window.crypto.subtle.generateKey({name:"AES-CTR",length:128},!0,["encrypt","decrypt"])}(),t=await async function(n){let e=await window.crypto.subtle.exportKey("raw",n);return new Uint8Array(e)}(e);let c=await i(a.keyVer,{name:"ECDSA",namedCurve:"P-384"},"verify");if(!await async function(n,e,t){let i=str2ab(atob(e)),a=r.encode(t);return window.crypto.subtle.verify({name:"ECDSA",hash:{name:"SHA-384"}},n,i,a)}(c,a.signature,function(n){return[n.challenge||"",n.keyEnc||"",n.keyVer||""].join("")}(a||{})))throw n=null,e=null,t=null,new Error("Signature invalid");console.log("Security Initialized!")}(a)},encrypt:function(i,a){return async function(i,a){let c=function(n){let e=new Uint8Array(16);return window.crypto.getRandomValues(e),e}(),u=new Uint8Array(c.length+t.length);u.set(c),u.set(t,c.length);let o=await async function(e){let t=e;return"string"==typeof e&&(t=r.encode(e)),window.crypto.subtle.encrypt("RSA-OAEP",n,t)}(u),l=await async function(n,e,t){let i=r.encode(t),a={name:"AES-CTR",counter:e,length:128};return window.crypto.subtle.encrypt(a,n,i)}(e,c,i);return!0===a?{d:l,k:o}:{d:buf2hex(l),k:buf2hex(o)}}(i,a)},decrypt:function(n){return async function(n){let t=n.iv,r=n.d,i=await async function(n,e,t){let r=hex2ab(t),i=hex2ab(e),a=new Uint8Array(i),c=new Uint8Array(r),u={name:"AES-CTR",counter:a,length:128};return window.crypto.subtle.decrypt(u,n,c)}(e,t,r);var a=stringFromUTF8Array(new Uint8Array(i)),c=JSON.parse(a);return"ws"==c.type&&"data"===c.cmd&&(c=c.data),c}(n)}};return Object.freeze(a),a})();
