...
/**
 * Helper class for handling RSA keys
...
enum RsaKey {
	 ...
	 * @throws Exception
	 */
	public static String signChallenge(final String data, final boolean isHex, final boolean webCryptoAPI) throws Exception {		
		if (isHex) {
