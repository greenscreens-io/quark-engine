...
public class WebSocketOperations<T> {
	...
	public final ExtJSDirectResponse<T> processEncrypted(final ExtJSDirectRequest<T> request,
	...
	public final ExtJSDirectResponse<T> process(final ExtJSDirectRequest<T> request, final HttpSession session,
			final String uri) {
